  ...
  return (
    <div className={classes.main}>
      ...
      <div className={classes.inputdiv}>
        ...
        <input className={classes.input} type="radio" id="happy2" name="happy2" value="Warm"></input>
        ...
        <input className={classes.input} type="radio" id="happy4" name="happy4" value="Amused"></input>
