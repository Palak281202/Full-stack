  ...
  return (
    <div className={classes.main}>
      ...
      <div className={classes.inputdiv}>
        <input className={classes.input} type="checkbox" id="awe1" name="awe1" value="Curious"></input>
        <label className={classes.label} for="awe1">Curious </label>
        <input className={classes.input} type="checkbox" id="awe2" name="awe2" value="Intrigued"></input>
        <label className={classes.label} for="awe2">Intrigued </label>
        <input className={classes.input} type="checkbox" id="awe3" name="awe3" value="Interested"></input>
        <label className={classes.label} for="awe3">Interested </label>
        <input className={classes.input} type="checkbox" id="awe4" name="awe4" value="Engaged"></input>
