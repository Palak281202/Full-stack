  ...
  return (
    <div className={classes.main}>
      ...
      <div className={classes.inputdiv}>
        ...
        <input className={classes.input} type="radio" id="angry4" name="angry4" value="Fed up"></input>
        <label className={classes.label} for="angry4">Fed up </label>
        <input className={classes.input} type="radio" id="angry5" name="angry5" value="Grumpy"></input>
        <label className={classes.label} for="angry5">Grumpy </label>
        <input className={classes.input} type="radio" id="angry6" name="angry6" value="Touchy"></input>
